...
tour = True
while tour:
    s_len = input(color.DARKCYAN + 'How many words do you want your mnemonic seed to have? (12/15/18/21/24)\n' + color.END)
    if s_len.isnumeric():
        s_len = int(s_len)
...
ran_bits = str(bin(random.randint(0, max_rand))[2:]) # random bits to add to reach entropy bits
